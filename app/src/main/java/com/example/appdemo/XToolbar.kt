...
class XToolbar : FrameLayout {
    ...
    //TODO Used with CardView and line bottom view
...
//        _binding.root.configMarginStatusBar()
        context.theme.obtainStyledAttributes(attributeSet, R.styleable.XToolbar, 0, 0).apply {
            try {
                ...
                cardElevation = getFloat(R.styleable.XToolbar_xtb_cardElevation, cardElevation)
    ...
    private fun setupView() {
        ...
        _binding.root.setBackgroundColor(colorBackground)

    }

    fun setCardElevation(elevation: Float) {
//        _binding.cardElevation.maxCardElevation = 8f
    }
